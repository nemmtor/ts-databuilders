...
export const kebabCaseDecoder = KebabCaseFromString.pipe(Schema.decode);
export const camelCaseDecoder = CamelCaseFromString.pipe(Schema.decode);
export const pascalCaseDecoder = PascalCaseFromString.pipe(Schema.decode);
export const normalizedCaseDecoder = NormalizedCase.pipe(Schema.decode);
