export const DESCRIPTIONS = {
  ...
  inlineDefaultJsDocTagName:
    'JSDoc tag used to set default value of given field.',
  withNestedbuilders:
  ...
  defaultNumber: 'Default number value to be used in data builder constructor.',
  defaultBoolean:
    'Default boolean value to be used in data builder constructor.',
};
